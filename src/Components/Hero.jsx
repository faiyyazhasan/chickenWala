      ...
      <div className=" row ">
        ...
        <div className="col-2 d-flex">
          <div className="  p-4">
            {" "}
            <img
              src="https://img.freepik.com/free-photo/top-view-fresh-fish-slices-with-red-tomatoes-dark-blue-table-ocean-meat-seafood-sea-meal-food-pepper-water-dish_179666-17776.jpg?ga=GA1.1.1784806605.1718554634&semt=ais_hybrid"
              style={{ height: "300px", width: "100%", borderRadius: "0px" }}
            />
            <div className="chicken-details p-3 item-details">
              <p>This all you can get on Chicken wala </p>
              <h5>Best brand from all over india</h5>
            </div>
            <div>
            <img
              src="https://img.freepik.com/free-photo/high-angle-raw-chicken-wooden-board-with-ingredients_23-2148440848.jpg?ga=GA1.1.1784806605.1718554634&semt=ais_hybrid"
              style={{ height: "300px", width: "100%", borderRadius: "0px" }}
            /><div className="chicken-details p-3 item-details">
            <p>Full Chicken wala </p>
            <h5>Fastest Delivery for everyone</h5>
          </div>
            </div>
          </div>
        </div>
