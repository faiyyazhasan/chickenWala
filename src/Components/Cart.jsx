          ...
          {cart.map((d) => (
            <div className="cart-item" key={d.id}>
              ...
              <div className="cart-details">
                ...
                <p className="cart-discount">Discount: ₹{d.discount}</p><p className="cart-description">{d.description}</p>
                <div className="button-group bg-light">
                  {" "}
                  <p className="cart-quantity d-flex">
                    Quantity:
                    <button
                      className="rounded circle btn btn-light border-0"
                      disabled={true}
                    >
                      {d.count}
                    </button>
                  ...
                  <button
                    className="rounded circle btn btn-primary bg-light  border-0 mb-3"
                  ...
                  <button
                    type="button"
                    className="btn btn-light rounded mb-3 border-0"
                    data-toggle="tooltip"
                    data-html="true"
                    title="Delete"
