  ...
  return (
    <div className="footer-section container-fluid mt-5 bg-light text-dark">
      <div className="footer-container">
        ...
        <div className="ft-list">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="#services">Healthy Meat</a>
            </li>
            <li>
              <a href="#services"> Chicken Expert</a>
            </li>
            <li>
              <a href="#services">Fish Expert</a>
            </li>
            <li>
              <a href="#services">Duck Expert</a>
            </li>
            <li>
              <a href="#services">Offers for bulk  </a>
            </li>
          </ul>
        </div>
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@healthplus.com">support@ChickenWala.com</a>
            </li>
            <li>
              <a href="mailto:appointment@ChickenWala.com">
                appointment@ChickenWala.com
              </a>
            </li>
            <li>
      ...
      <div className="ft-copyright">
        <p>© 2013-2023 ChickenWala. All rights reserved.</p>
